...
1. **ОС:** Windows 11
2. **Браузер:** Chrome 133.0.6943.98 (Официальная сборка)
3. **Тестируемый сайт:** http://tech-avito-intern.jumpingcrab.com/
...
| 4. Изменить цену в поле `name="price"`                 | --                                                       |                                                                    |
| 5. Изменить описание в поле `name="description"`       | <script>console.log(1)</script>                          |                                                                    |
